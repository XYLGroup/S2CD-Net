...
fileFolder=fullfile('/home/descfly/zly/datasets/Chikusei/mcodes/test/');
...
for i = 1:numel(fileNames)
    ...
    save(strcat('/home/descfly/zly/datasets/Chikusei/mcodes/dataset/Chikusei_x', num2str(scale), '/test/Chikusei_x', num2str(scale), '_test', int2str(i), '.mat'),'gt','lq','bic');
end